...
# simple code of a float input for the BRL and the result in USD
...
dol = brl / 5
print('A quantidade que você disse, em real, foi {:.2f}BRL e a conversão resultou em {:.2f}USD.'.format(brl, dol))
